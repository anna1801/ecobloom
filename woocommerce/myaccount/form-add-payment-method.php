	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="add-payment">
				...
				<button type="submit" class="btn btn-primary rounded-pill w-100 py-2 fw-bold woocommerce-Button woocommerce-Button--alt alt<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Save Payment Method', 'woocommerce' ); ?></button>
