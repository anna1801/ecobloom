...
<div class="about-story-box p-4 bg-white woocommerce-order-downloads">

	<h4 class="fw-bold text-dark mb-4"><?php esc_html_e( 'Available Downloadable Guides', 'woocommerce' ); ?></h4>
